                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td class="content-block" valign="top">
                                        <p>Bonjour '.$prenom.'</p>
                                        <p>Vous venez d\'être ajouter comme <b>éditeur</b> sur la platefomre Ivoire Box.</p>
                                ...
                                <tr style="text-align:center">
                                    <td class="content-block" itemprop="handler" itemscope itemtype="https://schema.org/HttpActionHandler" valign="top">
                                        <a href="'.$domaine.'/confirm/'.$mailToken.'" class="btn-primary" itemprop="url">Confirmer</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block" valign="top">
