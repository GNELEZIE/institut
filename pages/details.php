            ...
            <div class="row">
                <div class="col-xxl-12">
                    <div class="page__title-wrapper text-center">
                        <h3 class="pb-100">France Extend Health Insurance  Requirement</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="blog__details--wrapper mr-50 mb-50">
        <div class="ablog ablog-4 mb-55">
            <div class="ablog__img wow fadeInUp">
                <img src="<?=$cdn_domaine?>/assets/img/blog/blog-single/b1.jpg" class="img-fluid" alt="img">
            </div>
            <div class="ablog__text ablog__text4">
                ...
                <div class="blog__details--thumb mb-30 wow fadeInUp">
                    <img src="<?=$cdn_domaine?>/assets/img/blog/blog-single/b7.jpg" class="img-fluid" alt="img">
                </div>
        ...
        <div class="blog__author mb-95 d-sm-flex wow fadeInUp">
            <div class="blog__author-img mr-30">
                <img src="<?=$cdn_domaine?>/assets/img/blog/blog-single/blog-author.jpg" class="img-fluid" alt="img">
            </div>
            ...
            <div class="latest-comments">
                <ul>
                    <li>
                        <div class="comments-box">
                            <div class="comments-avatar">
                                <img src="<?=$cdn_domaine?>/assets/img/blog/blog-single/blog-sm-6.png" class="img-fluid" alt="img">
                            </div>
                    ...
                    <li class="children">
                        <div class="comments-box">
                            <div class="comments-avatar">
                                <img src="<?=$cdn_domaine?>/assets/img/blog/blog-single/blog-sm-7.png" class="img-fluid" alt="img">
                            </div>
                            <div class="comments-text">
                                <div class="avatar-name">
                                    <h5>Bailey Wonger</h5>
                    ...
                    <li class="children">
                        <div class="comments-box">
                            <div class="comments-avatar">
                                <img src="<?=$cdn_domaine?>/assets/img/blog/blog-single/blog-sm-8.png" class="img-fluid" alt="img">
                            </div>
                            <div class="comments-text">
                                <div class="avatar-name">
                                    <h5>Hilary Ouse</h5>
